...
const componentsPath = path.join(__dirname, '../src/Library')
...
module.exports = async () => {
    ...
    const components = await Promise.all(
        files.map(async name => {
            ...
            //const hasFile2 = await fsnormal.access(entry,(err) => {if(err)console.log(err)});
    ...
    console.log(componentsEntries['tree']);
    const configs = {
        mode : 'none' ,
