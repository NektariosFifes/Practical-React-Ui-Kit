...
export const ComponentWithDefaults =
    <PassedComponentType,Default_v_type>
    (Component:React.FunctionComponent<PassedComponentType>,default_values:Default_v_type) => {
